            ...
            <ul className="space-y-1">
              <li className="hover:text-yellow-500">
                <NavLink
                  ...
                  to="/"
                >
                  Branch 1: 824 Sư Vạn Hạnh, P12, Q10.
                </NavLink>
              </li>
              <li className="hover:text-yellow-500">
                <NavLink
              ...
              <li className="hover:text-yellow-500">
                <NavLink
                  ...
                  to="/"
                >
                  Branch 3: 221 Big C, P12, Q. Gò Vấp.
                </NavLink>
              </li>
            </ul>
          </div>
          <div className="space-y-4">
            ...
            <div className="flex justify-start space-x-3">
              <NavLink
                ...
                to="/"
                title="Facebook"
                className="flex items-center p-1 hover:text-yellow-500 text-white"
              >
                <svg
